...
public class PlanetHead implements Serializable {
    ...
    static {
        ...
        openapiFields.add("head_id");
        openapiFields.add("latitude");
        openapiFields.add("longitude");

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>();
        openapiRequiredFields.add("head_id");
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PlanetHead.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PlanetHead' and its
                             // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PlanetHead> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(PlanetHead.class));

            return (TypeAdapter<T>) new TypeAdapter<PlanetHead>() {
                @Override
                public void write(JsonWriter out, PlanetHead value) throws IOException {
    ...
    /**
     * Create an instance of PlanetHead given an JSON string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of PlanetHead
     * @throws IOException
     *             if the JSON string is invalid with respect to PlanetHead
     */
    public static PlanetHead fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PlanetHead.class);
    }

    /**
     * Convert an instance of PlanetHead to an JSON string
     *
     * @return JSON string
     */

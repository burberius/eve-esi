...
public class CharacterIndustryJobsResponse implements Serializable {
    ...
    public CharacterIndustryJobsResponse activityId(@javax.annotation.Nonnull Integer activityId) {
    ...
    public CharacterIndustryJobsResponse blueprintTypeId(@javax.annotation.Nonnull Integer blueprintTypeId) {
    ...
    public CharacterIndustryJobsResponse completedCharacterId(@javax.annotation.Nullable Integer completedCharacterId) {
    ...
    public CharacterIndustryJobsResponse duration(@javax.annotation.Nonnull Integer duration) {
    ...
    public CharacterIndustryJobsResponse installerId(@javax.annotation.Nonnull Integer installerId) {
    ...
    public CharacterIndustryJobsResponse jobId(@javax.annotation.Nonnull Integer jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public CharacterIndustryJobsResponse licensedRuns(@javax.annotation.Nullable Integer licensedRuns) {
    ...
    public CharacterIndustryJobsResponse probability(@javax.annotation.Nullable Float probability) {
    ...
    public CharacterIndustryJobsResponse productTypeId(@javax.annotation.Nullable Integer productTypeId) {
    ...
    public CharacterIndustryJobsResponse runs(@javax.annotation.Nonnull Integer runs) {
        this.runs = runs;
        return this;
    }
    ...
    public CharacterIndustryJobsResponse successfulRuns(@javax.annotation.Nullable Integer successfulRuns) {

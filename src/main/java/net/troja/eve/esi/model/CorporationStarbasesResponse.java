...
public class CorporationStarbasesResponse implements Serializable {
    ...
    public CorporationStarbasesResponse moonId(@javax.annotation.Nullable Long moonId) {
        this.moonId = moonId;
        return this;
    }
    ...
    public CorporationStarbasesResponse systemId(@javax.annotation.Nonnull Long systemId) {
    ...
    public CorporationStarbasesResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

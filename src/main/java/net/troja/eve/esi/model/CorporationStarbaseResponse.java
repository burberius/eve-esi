...
public class CorporationStarbaseResponse implements Serializable {
    ...
    private transient AnchorEnum anchorEnum;
    ...
    private Double attackSecurityStatusThreshold;
    ...
    @javax.annotation.Nullable
    private Double attackStandingThreshold;
    ...
    private transient FuelBayTakeEnum fuelBayTakeEnum;
    ...
    private transient FuelBayViewEnum fuelBayViewEnum;
    ...
    private transient OfflineEnum offlineEnum;
    ...
    private transient OnlineEnum onlineEnum;
    ...
    private transient UnanchorEnum unanchorEnum;
     ...
     */
    @javax.annotation.Nullable
    public Double getAttackSecurityStatusThreshold() {
        return attackSecurityStatusThreshold;
    }

    public void setAttackSecurityStatusThreshold(@javax.annotation.Nullable Double attackSecurityStatusThreshold) {
        this.attackSecurityStatusThreshold = attackSecurityStatusThreshold;
    }
     ...
     */
    @javax.annotation.Nullable
    public Double getAttackStandingThreshold() {
        return attackStandingThreshold;
    }

    public void setAttackStandingThreshold(@javax.annotation.Nullable Double attackStandingThreshold) {
        this.attackStandingThreshold = attackStandingThreshold;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("allow_alliance_members", "allow_corporation_members",
                "anchor", "attack_if_at_war", "attack_if_other_security_status_dropping",
                "attack_security_status_threshold", "attack_standing_threshold", "fuel_bay_take", "fuel_bay_view",
                "fuels", "offline", "online", "unanchor", "use_alliance_standings"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("allow_alliance_members",
                "allow_corporation_members", "anchor", "attack_if_at_war", "attack_if_other_security_status_dropping",
                "fuel_bay_take", "fuel_bay_view", "offline", "online", "unanchor", "use_alliance_standings"));
    }

...
public class DogmaDynamicItemsResponse implements Serializable {
    ...
    public DogmaDynamicItemsResponse dogmaAttributes(@javax.annotation.Nonnull List<DogmaAttribute> dogmaAttributes) {
        this.dogmaAttributes = dogmaAttributes;
        return this;
    }

    public DogmaDynamicItemsResponse addDogmaAttributesItem(DogmaAttribute dogmaAttributesItem) {
    ...
    public void setDogmaAttributes(@javax.annotation.Nonnull List<DogmaAttribute> dogmaAttributes) {
        this.dogmaAttributes = dogmaAttributes;
    }

    public DogmaDynamicItemsResponse dogmaEffects(@javax.annotation.Nonnull List<DogmaEffect> dogmaEffects) {
        this.dogmaEffects = dogmaEffects;
        return this;
    }

    public DogmaDynamicItemsResponse addDogmaEffectsItem(DogmaEffect dogmaEffectsItem) {
    ...
    public void setDogmaEffects(@javax.annotation.Nonnull List<DogmaEffect> dogmaEffects) {
        this.dogmaEffects = dogmaEffects;
    }

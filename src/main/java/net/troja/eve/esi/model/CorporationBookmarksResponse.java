...
public class CorporationBookmarksResponse implements Serializable {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!CorporationBookmarksResponse.openapiRequiredFields.isEmpty()) { // has
                                                                                 // required
                                                                                 // fields
                                                                                 // but
                                                                                 // JSON
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CorporationBookmarksResponse is not found in the empty JSON string",
                                CorporationBookmarksResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!CorporationBookmarksResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `CorporationBookmarksResponse` properties. JSON: %s",
        ...
        // JSON string
        for (String requiredField : CorporationBookmarksResponse.openapiRequiredFields) {
        ...
        if (jsonObj.get("coordinates") != null && !jsonObj.get("coordinates").isJsonNull()) {
            CorporationBookmarksCoordinates.validateJsonObject(jsonObj.getAsJsonObject("coordinates"));
        }
        // validate the optional field `item`
        if (jsonObj.get("item") != null && !jsonObj.get("item").isJsonNull()) {
            CorporationBookmarkItem.validateJsonObject(jsonObj.getAsJsonObject("item"));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CorporationBookmarksResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                             // 'CorporationBookmarksResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CorporationBookmarksResponse> thisAdapter = gson.getDelegateAdapter(this,
                    TypeToken.get(CorporationBookmarksResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<CorporationBookmarksResponse>() {
                @Override
                public void write(JsonWriter out, CorporationBookmarksResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public CorporationBookmarksResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of CorporationBookmarksResponse given an JSON string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of CorporationBookmarksResponse
     * @throws IOException
     *             if the JSON string is invalid with respect to
     *             CorporationBookmarksResponse
     */
    public static CorporationBookmarksResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CorporationBookmarksResponse.class);
    }

    /**
     * Convert an instance of CorporationBookmarksResponse to an JSON string
     *
     * @return JSON string
     */

...
public class CharacterRolesResponse implements Serializable {
    ...
    public CharacterRolesResponse roles(@javax.annotation.Nullable Set<RolesEnum> roles) {
        this.rolesEnum = roles;
        return this;
    }

    public CharacterRolesResponse rolesString(@javax.annotation.Nullable Set<String> roles) {
        this.roles = roles;
        return this;
    }
    ...
    public CharacterRolesResponse rolesAtBase(@javax.annotation.Nullable Set<RolesAtBaseEnum> rolesAtBase) {
        this.rolesAtBaseEnum = rolesAtBase;
        return this;
    }

    public CharacterRolesResponse rolesAtBaseString(@javax.annotation.Nullable Set<String> rolesAtBase) {
    ...
    public CharacterRolesResponse rolesAtHq(@javax.annotation.Nullable Set<RolesAtHqEnum> rolesAtHq) {
        this.rolesAtHqEnum = rolesAtHq;
        return this;
    }

    public CharacterRolesResponse rolesAtHqString(@javax.annotation.Nullable Set<String> rolesAtHq) {
    ...
    public CharacterRolesResponse rolesAtOther(@javax.annotation.Nullable Set<RolesAtOtherEnum> rolesAtOther) {
        this.rolesAtOtherEnum = rolesAtOther;
        return this;
    }

    public CharacterRolesResponse rolesAtOtherString(@javax.annotation.Nullable Set<String> rolesAtOther) {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("roles", "roles_at_base", "roles_at_hq", "roles_at_other"));

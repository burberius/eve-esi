...
/**
 * CharacterAssetsResponseInner
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class CharacterAssetsResponseInner implements Serializable {
    ...
    public CharacterAssetsResponseInner() {
    }

    public CharacterAssetsResponseInner isBlueprintCopy(@javax.annotation.Nullable Boolean isBlueprintCopy) {
    ...
    public CharacterAssetsResponseInner isSingleton(@javax.annotation.Nonnull Boolean isSingleton) {
    ...
    public CharacterAssetsResponseInner itemId(@javax.annotation.Nonnull Long itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public CharacterAssetsResponseInner locationFlag(@javax.annotation.Nonnull LocationFlagEnum locationFlag) {
        this.locationFlagEnum = locationFlag;
        return this;
    }

    public CharacterAssetsResponseInner locationFlagString(@javax.annotation.Nonnull String locationFlag) {
    ...
    public CharacterAssetsResponseInner locationId(@javax.annotation.Nonnull Long locationId) {
    ...
    public CharacterAssetsResponseInner locationType(@javax.annotation.Nonnull LocationTypeEnum locationType) {
        this.locationTypeEnum = locationType;
        return this;
    }

    public CharacterAssetsResponseInner locationTypeString(@javax.annotation.Nonnull String locationType) {
    ...
    public CharacterAssetsResponseInner quantity(@javax.annotation.Nonnull Long quantity) {
    ...
    public CharacterAssetsResponseInner typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        CharacterAssetsResponseInner characterAssetsResponseInner = (CharacterAssetsResponseInner) o;
        return Objects.equals(this.isBlueprintCopy, characterAssetsResponseInner.isBlueprintCopy)
                && Objects.equals(this.isSingleton, characterAssetsResponseInner.isSingleton)
                && Objects.equals(this.itemId, characterAssetsResponseInner.itemId)
                && Objects.equals(this.locationFlag, characterAssetsResponseInner.locationFlag)
                && Objects.equals(this.locationId, characterAssetsResponseInner.locationId)
                && Objects.equals(this.locationType, characterAssetsResponseInner.locationType)
                && Objects.equals(this.quantity, characterAssetsResponseInner.quantity)
                && Objects.equals(this.typeId, characterAssetsResponseInner.typeId);
    }
    ...
    public String toString() {
        ...
        sb.append("class CharacterAssetsResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CharacterAssetsResponseInner.openapiRequiredFields.isEmpty()) { // has
                                                                                 // required
                                                                                 // fields
                                                                                 // but
                                                                                 // JSON
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CharacterAssetsResponseInner is not found in the empty JSON string",
                                CharacterAssetsResponseInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CharacterAssetsResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `CharacterAssetsResponseInner` properties. JSON: %s",
        ...
        // JSON string
        for (String requiredField : CharacterAssetsResponseInner.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CharacterAssetsResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                             // 'CharacterAssetsResponseInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CharacterAssetsResponseInner> thisAdapter = gson.getDelegateAdapter(this,
                    TypeToken.get(CharacterAssetsResponseInner.class));

            return (TypeAdapter<T>) new TypeAdapter<CharacterAssetsResponseInner>() {
                @Override
                public void write(JsonWriter out, CharacterAssetsResponseInner value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public CharacterAssetsResponseInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of CharacterAssetsResponseInner given an JSON string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of CharacterAssetsResponseInner
     * @throws IOException
     *             if the JSON string is invalid with respect to
     *             CharacterAssetsResponseInner
     */
    public static CharacterAssetsResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CharacterAssetsResponseInner.class);
    }

    /**
     * Convert an instance of CharacterAssetsResponseInner to an JSON string
     *
     * @return JSON string
     */

...
public class CorporationStructuresResponse implements Serializable {
    ...
    public CorporationStructuresResponse currentVul(String currentVul) {
     ...
     * @return currentVul
     **/
    @ApiModelProperty(example = "null", required = true, value = "Set of {Day, Hour} for this week's vulnerability windows, Monday is day 0")
    public String getCurrentVul() {
        return currentVul;
    }

    public void setCurrentVul(String currentVul) {
        this.currentVul = currentVul;
    }
    ...
    public CorporationStructuresResponse nextVul(String nextVul) {
     ...
     * @return nextVul
     **/
    @ApiModelProperty(example = "null", required = true, value = "Set of {Day, Hour} for next week's vulnerability windows, Monday is day 0")
    public String getNextVul() {
        return nextVul;
    }

    public void setNextVul(String nextVul) {
        this.nextVul = nextVul;
    }
    ...
    public CorporationStructuresResponse services(String services) {

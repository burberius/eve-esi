...
public class StatusResponse implements Serializable {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("players", "server_version", "start_time", "vip"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("players", "server_version", "start_time"));
    }

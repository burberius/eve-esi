...
public class CharacterBlueprintsResponse implements Serializable {
    ...
    private transient LocationFlagEnum locationFlagEnum;
    ...
    public CharacterBlueprintsResponse itemId(@javax.annotation.Nonnull Long itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public CharacterBlueprintsResponse locationFlag(@javax.annotation.Nonnull LocationFlagEnum locationFlag) {
        this.locationFlagEnum = locationFlag;
        return this;
    }

    public CharacterBlueprintsResponse locationFlagString(@javax.annotation.Nonnull String locationFlag) {
    ...
    public CharacterBlueprintsResponse locationId(@javax.annotation.Nonnull Long locationId) {
    ...
    public CharacterBlueprintsResponse materialEfficiency(@javax.annotation.Nonnull Long materialEfficiency) {
    ...
    public CharacterBlueprintsResponse quantity(@javax.annotation.Nonnull Long quantity) {
    ...
    public CharacterBlueprintsResponse runs(@javax.annotation.Nonnull Long runs) {
        this.runs = runs;
        return this;
    }
    ...
    public CharacterBlueprintsResponse timeEfficiency(@javax.annotation.Nonnull Long timeEfficiency) {
    ...
    public CharacterBlueprintsResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

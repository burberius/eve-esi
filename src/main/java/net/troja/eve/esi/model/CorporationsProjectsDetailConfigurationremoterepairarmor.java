...
public class CorporationsProjectsDetailConfigurationremoterepairarmor implements Serializable {
    ...
    public CorporationsProjectsDetailConfigurationremoterepairarmor identities(
            @javax.annotation.Nullable List<CorporationsProjectsDetailConfigurationdamageshipIdentities> identities) {
        this.identities = identities;
        return this;
    }

    public CorporationsProjectsDetailConfigurationremoterepairarmor addIdentitiesItem(
    ...
    public CorporationsProjectsDetailConfigurationremoterepairarmor locations(
            @javax.annotation.Nullable List<CorporationsProjectsDetailConfigurationcapturefwcomplexLocations> locations) {
        this.locations = locations;
        return this;
    }

    public CorporationsProjectsDetailConfigurationremoterepairarmor addLocationsItem(
    ...
    public CorporationsProjectsDetailConfigurationremoterepairarmor ships(
            @javax.annotation.Nullable List<CorporationsProjectsDetailConfigurationdamageshipShips> ships) {
        this.ships = ships;
        return this;
    }

    public CorporationsProjectsDetailConfigurationremoterepairarmor addShipsItem(
    ...
    public boolean equals(Object o) {
        ...
        CorporationsProjectsDetailConfigurationremoterepairarmor corporationsProjectsDetailConfigurationremoterepairarmor = (CorporationsProjectsDetailConfigurationremoterepairarmor) o;
        return Objects.equals(this.identities, corporationsProjectsDetailConfigurationremoterepairarmor.identities)
                && Objects.equals(this.locations, corporationsProjectsDetailConfigurationremoterepairarmor.locations)
                && Objects.equals(this.ships, corporationsProjectsDetailConfigurationremoterepairarmor.ships);
    }
    ...
    public String toString() {
        ...
        sb.append("class CorporationsProjectsDetailConfigurationremoterepairarmor {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CorporationsProjectsDetailConfigurationremoterepairarmor.openapiRequiredFields.isEmpty()) { // has
                                                                                                             // required
                                                                                                             // fields
                                                                                                             // but
                                                                                                             // JSON
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CorporationsProjectsDetailConfigurationremoterepairarmor is not found in the empty JSON string",
                                CorporationsProjectsDetailConfigurationremoterepairarmor.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CorporationsProjectsDetailConfigurationremoterepairarmor.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `CorporationsProjectsDetailConfigurationremoterepairarmor` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CorporationsProjectsDetailConfigurationremoterepairarmor.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                             // 'CorporationsProjectsDetailConfigurationremoterepairarmor'
                             // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CorporationsProjectsDetailConfigurationremoterepairarmor> thisAdapter = gson
                    .getDelegateAdapter(this,
                            TypeToken.get(CorporationsProjectsDetailConfigurationremoterepairarmor.class));

            return (TypeAdapter<T>) new TypeAdapter<CorporationsProjectsDetailConfigurationremoterepairarmor>() {
                @Override
                public void write(JsonWriter out, CorporationsProjectsDetailConfigurationremoterepairarmor value)
                        throws IOException {
                ...
                @Override
                public CorporationsProjectsDetailConfigurationremoterepairarmor read(JsonReader in) throws IOException {
     ...
     * CorporationsProjectsDetailConfigurationremoterepairarmor given an JSON
     * string
     *
     * @param jsonString
     *            JSON string
     ...
     *             CorporationsProjectsDetailConfigurationremoterepairarmor
     */
    public static CorporationsProjectsDetailConfigurationremoterepairarmor fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, CorporationsProjectsDetailConfigurationremoterepairarmor.class);
    }

    /**
     * Convert an instance of
     * CorporationsProjectsDetailConfigurationremoterepairarmor to an JSON
     * string
     *
     * @return JSON string
     */

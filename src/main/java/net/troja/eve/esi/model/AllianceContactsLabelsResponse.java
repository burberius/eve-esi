...
public class AllianceContactsLabelsResponse implements Serializable {
    ...
    public AllianceContactsLabelsResponse labelId(@javax.annotation.Nonnull Long labelId) {
    ...
    public AllianceContactsLabelsResponse labelName(@javax.annotation.Nonnull String labelName) {

...
public class CharacterCalendarResponse implements Serializable {
    ...
    public CharacterCalendarResponse eventId(@javax.annotation.Nullable Long eventId) {
    ...
    public CharacterCalendarResponse importance(@javax.annotation.Nullable Long importance) {

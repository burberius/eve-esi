...
public class IndustryFacilitiesResponse implements Serializable {
    ...
    public IndustryFacilitiesResponse ownerId(@javax.annotation.Nonnull Long ownerId) {
    ...
    public IndustryFacilitiesResponse regionId(@javax.annotation.Nonnull Long regionId) {
    ...
    public IndustryFacilitiesResponse solarSystemId(@javax.annotation.Nonnull Long solarSystemId) {
    ...
    public IndustryFacilitiesResponse tax(@javax.annotation.Nullable Double tax) {
        this.tax = tax;
        return this;
    }
    ...
    public IndustryFacilitiesResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

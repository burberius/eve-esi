...
public class MarketGroupResponse implements Serializable {
    ...
    public void setMarketGroupId(@javax.annotation.Nonnull Long marketGroupId) {
        this.marketGroupId = marketGroupId;
    }
    ...
    public void setParentGroupId(@javax.annotation.Nullable Long parentGroupId) {
        this.parentGroupId = parentGroupId;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("description", "market_group_id", "name", "parent_group_id",
                "types"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("description", "market_group_id", "name", "types"));
    }

...
public class CharacterWalletTransactionsResponse implements Serializable {
    ...
    public CharacterWalletTransactionsResponse clientId(@javax.annotation.Nonnull Long clientId) {
    ...
    public CharacterWalletTransactionsResponse quantity(@javax.annotation.Nonnull Long quantity) {
    ...
    public CharacterWalletTransactionsResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

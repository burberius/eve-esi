...
public class FleetWingCreatedResponse implements Serializable {
        ...
        if (jsonObj == null) {
            if (!FleetWingCreatedResponse.openapiRequiredFields.isEmpty()) { // has
                ...
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in FleetWingCreatedResponse is not found in the empty JSON string",
                        FleetWingCreatedResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FleetWingCreatedResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                             // 'FleetWingCreatedResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FleetWingCreatedResponse> thisAdapter = gson.getDelegateAdapter(this,
                    TypeToken.get(FleetWingCreatedResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<FleetWingCreatedResponse>() {
                @Override
                public void write(JsonWriter out, FleetWingCreatedResponse value) throws IOException {
    ...
    /**
     * Create an instance of FleetWingCreatedResponse given an JSON string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of FleetWingCreatedResponse
     * @throws IOException
     *             if the JSON string is invalid with respect to
     *             FleetWingCreatedResponse
     */
    public static FleetWingCreatedResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FleetWingCreatedResponse.class);
    }

    /**
     * Convert an instance of FleetWingCreatedResponse to an JSON string
     *
     * @return JSON string
     */

...
public class PublicContractsResponse implements Serializable {
    ...
    public PublicContractsResponse contractId(@javax.annotation.Nonnull Long contractId) {
    ...
    public PublicContractsResponse daysToComplete(@javax.annotation.Nullable Long daysToComplete) {
    ...
    public PublicContractsResponse issuerCorporationId(@javax.annotation.Nonnull Long issuerCorporationId) {
    ...
    public PublicContractsResponse issuerId(@javax.annotation.Nonnull Long issuerId) {

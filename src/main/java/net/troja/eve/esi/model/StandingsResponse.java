...
public class StandingsResponse implements Serializable {
    ...
    public StandingsResponse fromId(@javax.annotation.Nonnull Long fromId) {
        this.fromId = fromId;
        return this;
    }
    ...
    public StandingsResponse fromType(@javax.annotation.Nonnull FromTypeEnum fromType) {
        this.fromTypeEnum = fromType;
        return this;
    }

    public StandingsResponse fromTypeString(@javax.annotation.Nonnull String fromType) {
    ...
    public StandingsResponse standing(@javax.annotation.Nonnull Double standing) {
    ...
    public boolean equals(Object o) {
        ...
        StandingsResponse characterStandingsResponse = (StandingsResponse) o;
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!StandingsResponse.openapiRequiredFields.isEmpty()) { // has
                                                                      // required
                                                                      // fields
                                                                      // but
                                                                      // JSON
                ...
                throw new IllegalArgumentException(String.format(
                        "The required field(s) %s in StandingsResponse is not found in the empty JSON string",
                        StandingsResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!StandingsResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `StandingsResponse` properties. JSON: %s",
        ...
        // JSON string
        for (String requiredField : StandingsResponse.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!StandingsResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'StandingsResponse'
                             // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<StandingsResponse> thisAdapter = gson.getDelegateAdapter(this,
                    TypeToken.get(StandingsResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<StandingsResponse>() {
                @Override
                public void write(JsonWriter out, StandingsResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public StandingsResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of StandingsResponse given an JSON string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of StandingsResponse
     * @throws IOException
     *             if the JSON string is invalid with respect to
     *             StandingsResponse
     */
    public static StandingsResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, StandingsResponse.class);
    }

    /**
     * Convert an instance of StandingsResponse to an JSON string
     *
     * @return JSON string
     */

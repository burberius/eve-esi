...
public class CorporationOrdersHistoryResponse implements Serializable {
    ...
    public CorporationOrdersHistoryResponse duration(@javax.annotation.Nonnull Integer duration) {
    ...
    public CorporationOrdersHistoryResponse issuedBy(@javax.annotation.Nullable Integer issuedBy) {
    ...
    public void setIssuedBy(@javax.annotation.Nullable Integer issuedBy) {
        this.issuedBy = issuedBy;
    }
    ...
    public CorporationOrdersHistoryResponse minVolume(@javax.annotation.Nullable Integer minVolume) {
    ...
    public CorporationOrdersHistoryResponse regionId(@javax.annotation.Nonnull Integer regionId) {
    ...
    public CorporationOrdersHistoryResponse typeId(@javax.annotation.Nonnull Integer typeId) {
        this.typeId = typeId;
        return this;
    }
    ...
    public CorporationOrdersHistoryResponse volumeRemain(@javax.annotation.Nonnull Integer volumeRemain) {
    ...
    public CorporationOrdersHistoryResponse volumeTotal(@javax.annotation.Nonnull Integer volumeTotal) {
    ...
    public CorporationOrdersHistoryResponse walletDivision(@javax.annotation.Nonnull Integer walletDivision) {

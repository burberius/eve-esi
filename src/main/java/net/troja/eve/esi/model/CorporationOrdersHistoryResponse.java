...
public class CorporationOrdersHistoryResponse implements Serializable {
    ...
    public CorporationOrdersHistoryResponse duration(@javax.annotation.Nonnull Long duration) {
    ...
    public CorporationOrdersHistoryResponse escrow(@javax.annotation.Nullable Double escrow) {
        this.escrow = escrow;
        return this;
    }
    ...
    public CorporationOrdersHistoryResponse isBuyOrder(@javax.annotation.Nullable Boolean isBuyOrder) {
    ...
    public CorporationOrdersHistoryResponse issued(@javax.annotation.Nonnull OffsetDateTime issued) {
        this.issued = issued;
        return this;
    }
    ...
    public CorporationOrdersHistoryResponse issuedBy(@javax.annotation.Nullable Long issuedBy) {
    ...
    public CorporationOrdersHistoryResponse locationId(@javax.annotation.Nonnull Long locationId) {
    ...
    public CorporationOrdersHistoryResponse minVolume(@javax.annotation.Nullable Long minVolume) {
    ...
    public CorporationOrdersHistoryResponse orderId(@javax.annotation.Nonnull Long orderId) {
    ...
    public CorporationOrdersHistoryResponse price(@javax.annotation.Nonnull Double price) {
        this.price = price;
        return this;
    }
    ...
    public CorporationOrdersHistoryResponse range(@javax.annotation.Nonnull RangeEnum range) {
        this.rangeEnum = range;
        return this;
    }

    public CorporationOrdersHistoryResponse rangeString(@javax.annotation.Nonnull String range) {
        this.range = range;
        return this;
    }
    ...
    public CorporationOrdersHistoryResponse regionId(@javax.annotation.Nonnull Long regionId) {
    ...
    public CorporationOrdersHistoryResponse state(@javax.annotation.Nonnull StateEnum state) {
        this.stateEnum = state;
        return this;
    }

    public CorporationOrdersHistoryResponse stateString(@javax.annotation.Nonnull String state) {
        this.state = state;
        return this;
    }
    ...
    public CorporationOrdersHistoryResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }
    ...
    public CorporationOrdersHistoryResponse volumeRemain(@javax.annotation.Nonnull Long volumeRemain) {
    ...
    public CorporationOrdersHistoryResponse volumeTotal(@javax.annotation.Nonnull Long volumeTotal) {
    ...
    public CorporationOrdersHistoryResponse walletDivision(@javax.annotation.Nonnull Long walletDivision) {

...
public class FactionWarfareLeaderboardCharacterVictoryPoints implements Serializable {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        for (int i = 0; i < jsonArrayactiveTotal.size(); i++) {
            FactionWarfareLeaderboardCharactersActiveTotalVictoryPoints.validateJsonObject(jsonArrayactiveTotal.get(i)
                    .getAsJsonObject());
        };
        // ensure the json data is an array
        ...
        for (int i = 0; i < jsonArraylastWeek.size(); i++) {
            FactionWarfareLeaderboardCharactersLastWeekVictoryPoints.validateJsonObject(jsonArraylastWeek.get(i)
                    .getAsJsonObject());
        };
        // ensure the json data is an array
        ...
        for (int i = 0; i < jsonArrayyesterday.size(); i++) {
            FactionWarfareLeaderboardCharactersYesterdayVictoryPoints.validateJsonObject(jsonArrayyesterday.get(i)
                    .getAsJsonObject());
        };
    }

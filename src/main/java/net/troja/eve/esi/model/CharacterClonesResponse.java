...
public class CharacterClonesResponse implements Serializable {
    ...
    public CharacterClonesResponse jumpClones(@javax.annotation.Nonnull List<JumpClone> jumpClones) {
        this.jumpClones = jumpClones;
        return this;
    }

    public CharacterClonesResponse addJumpClonesItem(JumpClone jumpClonesItem) {
    ...
    public void setJumpClones(@javax.annotation.Nonnull List<JumpClone> jumpClones) {
        this.jumpClones = jumpClones;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (int i = 0; i < jsonArrayjumpClones.size(); i++) {
            JumpClone.validateJsonElement(jsonArrayjumpClones.get(i));
        };
    }

...
public class CharacterClonesResponse implements Serializable {
    ...
    private CharacterClonesResponseHomeLocation homeLocation;
    ...
    public CharacterClonesResponse homeLocation(
            @javax.annotation.Nullable CharacterClonesResponseHomeLocation homeLocation) {
    ...
    public void setHomeLocation(@javax.annotation.Nullable CharacterClonesResponseHomeLocation homeLocation) {
        this.homeLocation = homeLocation;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("home_location", "jump_clones", "last_clone_jump_date",
                "last_station_change_date"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("jump_clones"));
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (jsonObj.get("home_location") != null && !jsonObj.get("home_location").isJsonNull()) {
            CharacterClonesResponseHomeLocation.validateJsonElement(jsonObj.get("home_location"));
        }

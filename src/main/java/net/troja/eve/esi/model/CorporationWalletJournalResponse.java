...
public class CorporationWalletJournalResponse implements Serializable {
    ...
    private transient ContextIdTypeEnum contextIdTypeEnum;
    ...
    private transient RefTypeEnum refTypeEnum;
    ...
    public CorporationWalletJournalResponse amount(@javax.annotation.Nullable Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public CorporationWalletJournalResponse balance(@javax.annotation.Nullable Double balance) {
    ...
    public CorporationWalletJournalResponse contextId(@javax.annotation.Nullable Long contextId) {
    ...
    public CorporationWalletJournalResponse contextIdType(@javax.annotation.Nullable ContextIdTypeEnum contextIdType) {
        this.contextIdTypeEnum = contextIdType;
        return this;
    }

    public CorporationWalletJournalResponse contextIdTypeString(@javax.annotation.Nullable String contextIdType) {
    ...
    public CorporationWalletJournalResponse date(@javax.annotation.Nonnull OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public CorporationWalletJournalResponse description(@javax.annotation.Nonnull String description) {
    ...
    public CorporationWalletJournalResponse firstPartyId(@javax.annotation.Nullable Long firstPartyId) {
    ...
    public CorporationWalletJournalResponse id(@javax.annotation.Nonnull Long id) {
        this.id = id;
        return this;
    }
    ...
    public CorporationWalletJournalResponse reason(@javax.annotation.Nullable String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public CorporationWalletJournalResponse refType(@javax.annotation.Nonnull RefTypeEnum refType) {
        this.refTypeEnum = refType;
        return this;
    }

    public CorporationWalletJournalResponse refTypeString(@javax.annotation.Nonnull String refType) {
    ...
    public CorporationWalletJournalResponse secondPartyId(@javax.annotation.Nullable Long secondPartyId) {
    ...
    public CorporationWalletJournalResponse tax(@javax.annotation.Nullable Double tax) {
        this.tax = tax;
        return this;
    }
    ...
    public CorporationWalletJournalResponse taxReceiverId(@javax.annotation.Nullable Long taxReceiverId) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CorporationWalletJournalResponse.openapiRequiredFields.isEmpty()) { // has
                                                                                     // required
                                                                                     // fields
                                                                                     // but
                                                                                     // JSON
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CorporationWalletJournalResponse is not found in the empty JSON string",
                                CorporationWalletJournalResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CorporationWalletJournalResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `CorporationWalletJournalResponse` properties. JSON: %s",
        ...
        // JSON string
        for (String requiredField : CorporationWalletJournalResponse.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CorporationWalletJournalResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                             // 'CorporationWalletJournalResponse' and its
                             // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CorporationWalletJournalResponse> thisAdapter = gson.getDelegateAdapter(this,
                    TypeToken.get(CorporationWalletJournalResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<CorporationWalletJournalResponse>() {
                @Override
                public void write(JsonWriter out, CorporationWalletJournalResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public CorporationWalletJournalResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of CorporationWalletJournalResponse given an JSON
     * string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of CorporationWalletJournalResponse
     * @throws IOException
     *             if the JSON string is invalid with respect to
     *             CorporationWalletJournalResponse
     */
    public static CorporationWalletJournalResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CorporationWalletJournalResponse.class);
    }

    /**
     * Convert an instance of CorporationWalletJournalResponse to an JSON string
     *
     * @return JSON string
     */

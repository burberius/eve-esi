...
public class CharacterStandingsResponse implements Serializable {
    ...
    public CharacterStandingsResponse fromId(@javax.annotation.Nonnull Long fromId) {
        this.fromId = fromId;
        return this;
    }
    ...
    public CharacterStandingsResponse fromType(@javax.annotation.Nonnull FromTypeEnum fromType) {
        this.fromTypeEnum = fromType;
        return this;
    }

    public CharacterStandingsResponse fromTypeString(@javax.annotation.Nonnull String fromType) {
    ...
    public CharacterStandingsResponse standing(@javax.annotation.Nonnull Double standing) {

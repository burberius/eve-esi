...
public class CorporationRolesResponse implements Serializable {
    ...
    private transient Set<GrantableRolesEnum> grantableRolesEnum;
    ...
    private transient Set<GrantableRolesAtBaseEnum> grantableRolesAtBaseEnum;
    ...
    private transient Set<GrantableRolesAtHqEnum> grantableRolesAtHqEnum;
    ...
    private transient Set<GrantableRolesAtOtherEnum> grantableRolesAtOtherEnum;
    ...
    private transient Set<RolesEnum> rolesEnum;
    ...
    private transient Set<RolesAtBaseEnum> rolesAtBaseEnum;
    ...
    private transient Set<RolesAtHqEnum> rolesAtHqEnum;
    ...
    private transient Set<RolesAtOtherEnum> rolesAtOtherEnum;

    public CorporationRolesResponse() {
    }

    public CorporationRolesResponse characterId(@javax.annotation.Nonnull Long characterId) {
    ...
    public CorporationRolesResponse grantableRoles(@javax.annotation.Nullable Set<GrantableRolesEnum> grantableRoles) {
        this.grantableRolesEnum = grantableRoles;
        return this;
    }

    public CorporationRolesResponse grantableRolesString(@javax.annotation.Nullable Set<String> grantableRoles) {
    ...
    public CorporationRolesResponse grantableRolesAtHqString(@javax.annotation.Nullable Set<String> grantableRolesAtHq) {
    ...
    public CorporationRolesResponse roles(@javax.annotation.Nullable Set<RolesEnum> roles) {
        this.rolesEnum = roles;
        return this;
    }

    public CorporationRolesResponse rolesString(@javax.annotation.Nullable Set<String> roles) {
        this.roles = roles;
        return this;
    }
    ...
    public CorporationRolesResponse rolesAtBase(@javax.annotation.Nullable Set<RolesAtBaseEnum> rolesAtBase) {
        this.rolesAtBaseEnum = rolesAtBase;
        return this;
    }

    public CorporationRolesResponse rolesAtBaseString(@javax.annotation.Nullable Set<String> rolesAtBase) {
    ...
    public CorporationRolesResponse rolesAtHq(@javax.annotation.Nullable Set<RolesAtHqEnum> rolesAtHq) {
        this.rolesAtHqEnum = rolesAtHq;
        return this;
    }

    public CorporationRolesResponse rolesAtHqString(@javax.annotation.Nullable Set<String> rolesAtHq) {
    ...
    public CorporationRolesResponse rolesAtOther(@javax.annotation.Nullable Set<RolesAtOtherEnum> rolesAtOther) {
        this.rolesAtOtherEnum = rolesAtOther;
        return this;
    }

    public CorporationRolesResponse rolesAtOtherString(@javax.annotation.Nullable Set<String> rolesAtOther) {

...
public class CharacterFleetResponse implements Serializable {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("fleet_boss_id", "fleet_id", "role", "squad_id", "wing_id"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("fleet_boss_id", "fleet_id", "role", "squad_id",
                "wing_id"));
    }

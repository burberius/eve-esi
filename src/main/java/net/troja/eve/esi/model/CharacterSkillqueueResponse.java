...
public class CharacterSkillqueueResponse implements Serializable {
    ...
    public CharacterSkillqueueResponse finishedLevel(@javax.annotation.Nonnull Long finishedLevel) {
    ...
    public CharacterSkillqueueResponse levelEndSp(@javax.annotation.Nullable Long levelEndSp) {
    ...
    public CharacterSkillqueueResponse levelStartSp(@javax.annotation.Nullable Long levelStartSp) {
    ...
    public CharacterSkillqueueResponse queuePosition(@javax.annotation.Nonnull Long queuePosition) {
    ...
    public CharacterSkillqueueResponse skillId(@javax.annotation.Nonnull Long skillId) {
    ...
    public CharacterSkillqueueResponse trainingStartSp(@javax.annotation.Nullable Long trainingStartSp) {

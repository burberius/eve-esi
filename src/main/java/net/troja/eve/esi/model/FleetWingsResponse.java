...
public class FleetWingsResponse implements Serializable {
    ...
    public FleetWingsResponse squads(@javax.annotation.Nonnull List<Squad> squads) {
        this.squads = squads;
        return this;
    }
    ...
    public void setSquads(@javax.annotation.Nonnull List<Squad> squads) {
        this.squads = squads;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (int i = 0; i < jsonArraysquads.size(); i++) {
            Squad.validateJsonElement(jsonArraysquads.get(i));
        };
    }

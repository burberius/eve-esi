...
import net.troja.eve.esi.model.FleetWingsResponseSquads;
...
public class FleetWingsResponse implements Serializable {
    ...
    @javax.annotation.Nonnull
    private List<FleetWingsResponseSquads> squads;

    public FleetWingsResponse() {
    }

    public FleetWingsResponse id(@javax.annotation.Nonnull Long id) {
        this.id = id;
        return this;
    }
    ...
    public FleetWingsResponse name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public FleetWingsResponse squads(@javax.annotation.Nonnull List<FleetWingsResponseSquads> squads) {
        this.squads = squads;
        return this;
    }

    public FleetWingsResponse addSquadsItem(FleetWingsResponseSquads squadsItem) {
        if (this.squads == null) {
     ...
     */
    @javax.annotation.Nonnull
    public List<FleetWingsResponseSquads> getSquads() {
        return squads;
    }

    public void setSquads(@javax.annotation.Nonnull List<FleetWingsResponseSquads> squads) {
        this.squads = squads;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (int i = 0; i < jsonArraysquads.size(); i++) {
            FleetWingsResponseSquads.validateJsonElement(jsonArraysquads.get(i));
        };
    }

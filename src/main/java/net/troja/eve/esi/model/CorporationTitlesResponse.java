...
public class CorporationTitlesResponse implements Serializable {
    ...
    public CorporationTitlesResponse grantableRoles(@javax.annotation.Nullable Set<GrantableRolesEnum> grantableRoles) {
        this.grantableRolesEnum = grantableRoles;
        return this;
    }

    public CorporationTitlesResponse grantableRolesString(@javax.annotation.Nullable Set<String> grantableRoles) {
    ...
    public CorporationTitlesResponse grantableRolesAtHqString(@javax.annotation.Nullable Set<String> grantableRolesAtHq) {
    ...
    public CorporationTitlesResponse roles(@javax.annotation.Nullable Set<RolesEnum> roles) {
        this.rolesEnum = roles;
        return this;
    }

    public CorporationTitlesResponse rolesString(@javax.annotation.Nullable Set<String> roles) {
        this.roles = roles;
        return this;
    }
    ...
    public CorporationTitlesResponse rolesAtBase(@javax.annotation.Nullable Set<RolesAtBaseEnum> rolesAtBase) {
        this.rolesAtBaseEnum = rolesAtBase;
        return this;
    }

    public CorporationTitlesResponse rolesAtBaseString(@javax.annotation.Nullable Set<String> rolesAtBase) {
    ...
    public CorporationTitlesResponse rolesAtHq(@javax.annotation.Nullable Set<RolesAtHqEnum> rolesAtHq) {
        this.rolesAtHqEnum = rolesAtHq;
        return this;
    }

    public CorporationTitlesResponse rolesAtHqString(@javax.annotation.Nullable Set<String> rolesAtHq) {
    ...
    public CorporationTitlesResponse rolesAtOther(@javax.annotation.Nullable Set<RolesAtOtherEnum> rolesAtOther) {
        this.rolesAtOtherEnum = rolesAtOther;
        return this;
    }

    public CorporationTitlesResponse rolesAtOtherString(@javax.annotation.Nullable Set<String> rolesAtOther) {
    ...
    public CorporationTitlesResponse titleId(@javax.annotation.Nullable Long titleId) {

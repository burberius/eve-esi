...
public class IncursionsResponse implements Serializable {
    ...
    public IncursionsResponse constellationId(@javax.annotation.Nonnull Long constellationId) {
    ...
    public IncursionsResponse factionId(@javax.annotation.Nonnull Long factionId) {
    ...
    public IncursionsResponse infestedSolarSystems(@javax.annotation.Nonnull List<Long> infestedSolarSystems) {
    ...
    public IncursionsResponse influence(@javax.annotation.Nonnull Double influence) {
    ...
    public IncursionsResponse stagingSolarSystemId(@javax.annotation.Nonnull Long stagingSolarSystemId) {

...
public class AllianceContactsResponse implements Serializable {
    ...
    private transient ContactTypeEnum contactTypeEnum;
    ...
    public AllianceContactsResponse contactId(@javax.annotation.Nonnull Long contactId) {
    ...
    public AllianceContactsResponse standing(@javax.annotation.Nonnull Double standing) {

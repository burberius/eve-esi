...
public class CharacterShipResponse implements Serializable {
    ...
    public CharacterShipResponse shipTypeId(@javax.annotation.Nonnull Long shipTypeId) {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("ship_item_id", "ship_name", "ship_type_id"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("ship_item_id", "ship_name", "ship_type_id"));
    }

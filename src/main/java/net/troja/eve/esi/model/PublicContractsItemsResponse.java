...
public class PublicContractsItemsResponse implements Serializable {
    ...
    public PublicContractsItemsResponse materialEfficiency(@javax.annotation.Nullable Long materialEfficiency) {
    ...
    public PublicContractsItemsResponse quantity(@javax.annotation.Nonnull Long quantity) {
    ...
    public PublicContractsItemsResponse runs(@javax.annotation.Nullable Long runs) {
        this.runs = runs;
        return this;
    }
    ...
    public PublicContractsItemsResponse timeEfficiency(@javax.annotation.Nullable Long timeEfficiency) {
    ...
    public PublicContractsItemsResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

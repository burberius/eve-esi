...
public class CorporationsProjectsDetailConfigurationdestroyship implements Serializable {
    ...
    public CorporationsProjectsDetailConfigurationdestroyship identities(
            @javax.annotation.Nullable List<CorporationsProjectsDetailConfigurationdamageshipIdentities> identities) {
        this.identities = identities;
        return this;
    }

    public CorporationsProjectsDetailConfigurationdestroyship addIdentitiesItem(
    ...
    public CorporationsProjectsDetailConfigurationdestroyship locations(
            @javax.annotation.Nullable List<CorporationsProjectsDetailConfigurationcapturefwcomplexLocations> locations) {
        this.locations = locations;
        return this;
    }

    public CorporationsProjectsDetailConfigurationdestroyship addLocationsItem(
    ...
    public CorporationsProjectsDetailConfigurationdestroyship ships(
            @javax.annotation.Nullable List<CorporationsProjectsDetailConfigurationdamageshipShips> ships) {
        this.ships = ships;
        return this;
    }

    public CorporationsProjectsDetailConfigurationdestroyship addShipsItem(
    ...
    public boolean equals(Object o) {
        ...
        CorporationsProjectsDetailConfigurationdestroyship corporationsProjectsDetailConfigurationdestroyship = (CorporationsProjectsDetailConfigurationdestroyship) o;
        return Objects.equals(this.identities, corporationsProjectsDetailConfigurationdestroyship.identities)
                && Objects.equals(this.locations, corporationsProjectsDetailConfigurationdestroyship.locations)
                && Objects.equals(this.ships, corporationsProjectsDetailConfigurationdestroyship.ships);
    }
    ...
    public String toString() {
        ...
        sb.append("class CorporationsProjectsDetailConfigurationdestroyship {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CorporationsProjectsDetailConfigurationdestroyship.openapiRequiredFields.isEmpty()) { // has
                                                                                                       // required
                                                                                                       // fields
                                                                                                       // but
                                                                                                       // JSON
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CorporationsProjectsDetailConfigurationdestroyship is not found in the empty JSON string",
                                CorporationsProjectsDetailConfigurationdestroyship.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CorporationsProjectsDetailConfigurationdestroyship.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `CorporationsProjectsDetailConfigurationdestroyship` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CorporationsProjectsDetailConfigurationdestroyship.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                             // 'CorporationsProjectsDetailConfigurationdestroyship'
                             // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CorporationsProjectsDetailConfigurationdestroyship> thisAdapter = gson
                    .getDelegateAdapter(this, TypeToken.get(CorporationsProjectsDetailConfigurationdestroyship.class));

            return (TypeAdapter<T>) new TypeAdapter<CorporationsProjectsDetailConfigurationdestroyship>() {
                @Override
                public void write(JsonWriter out, CorporationsProjectsDetailConfigurationdestroyship value)
                        throws IOException {
                ...
                @Override
                public CorporationsProjectsDetailConfigurationdestroyship read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of CorporationsProjectsDetailConfigurationdestroyship
     * given an JSON string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of CorporationsProjectsDetailConfigurationdestroyship
     * @throws IOException
     *             if the JSON string is invalid with respect to
     *             CorporationsProjectsDetailConfigurationdestroyship
     */
    public static CorporationsProjectsDetailConfigurationdestroyship fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CorporationsProjectsDetailConfigurationdestroyship.class);
    }

    /**
     * Convert an instance of CorporationsProjectsDetailConfigurationdestroyship
     * to an JSON string
     *
     * @return JSON string
     */

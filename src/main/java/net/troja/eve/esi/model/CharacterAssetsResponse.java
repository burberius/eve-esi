...
public class CharacterAssetsResponse implements Serializable {
    ...
    public CharacterAssetsResponse quantity(@javax.annotation.Nonnull Long quantity) {
    ...
    public CharacterAssetsResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

...
public class CorporationMedalsIssuedResponse implements Serializable {
    ...
    public CorporationMedalsIssuedResponse characterId(@javax.annotation.Nonnull Long characterId) {
    ...
    public CorporationMedalsIssuedResponse issuerId(@javax.annotation.Nonnull Long issuerId) {
    ...
    public CorporationMedalsIssuedResponse medalId(@javax.annotation.Nonnull Long medalId) {

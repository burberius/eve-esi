...
public class FleetMembersResponse implements Serializable {
    ...
    public FleetMembersResponse characterId(@javax.annotation.Nonnull Long characterId) {
    ...
    public FleetMembersResponse shipTypeId(@javax.annotation.Nonnull Long shipTypeId) {
    ...
    public FleetMembersResponse solarSystemId(@javax.annotation.Nonnull Long solarSystemId) {

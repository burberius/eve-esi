...
public class WarResponseDefender implements Serializable {
    ...
    public WarResponseDefender allianceId(Integer allianceId) {
    ...
    public WarResponseDefender corporationId(Integer corporationId) {
    ...
    public WarResponseDefender iskDestroyed(Float iskDestroyed) {
    ...
    public WarResponseDefender shipsKilled(Integer shipsKilled) {

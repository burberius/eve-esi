...
public class CategoryResponse implements Serializable {
    ...
    public CategoryResponse categoryId(@javax.annotation.Nonnull Long categoryId) {
    ...
    public CategoryResponse groups(@javax.annotation.Nonnull List<Long> groups) {
        this.groups = groups;
        return this;
    }

    public CategoryResponse addGroupsItem(Long groupsItem) {
        if (this.groups == null) {
    ...
    public void setGroups(@javax.annotation.Nonnull List<Long> groups) {
        this.groups = groups;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("category_id", "groups", "name", "published"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("category_id", "groups", "name", "published"));
    }

...
public class CharacterContractsItemsResponse implements Serializable {
    ...
    public CharacterContractsItemsResponse isIncluded(@javax.annotation.Nonnull Boolean isIncluded) {
    ...
    public CharacterContractsItemsResponse isSingleton(@javax.annotation.Nonnull Boolean isSingleton) {
    ...
    public CharacterContractsItemsResponse quantity(@javax.annotation.Nonnull Integer quantity) {
    ...
    public CharacterContractsItemsResponse rawQuantity(@javax.annotation.Nullable Integer rawQuantity) {
    ...
    public CharacterContractsItemsResponse recordId(@javax.annotation.Nonnull Long recordId) {
    ...
    public CharacterContractsItemsResponse typeId(@javax.annotation.Nonnull Integer typeId) {
        this.typeId = typeId;
        return this;
    }

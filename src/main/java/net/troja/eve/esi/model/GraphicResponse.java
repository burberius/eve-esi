...
public class GraphicResponse implements Serializable {
    ...
    public GraphicResponse graphicId(@javax.annotation.Nonnull Long graphicId) {
    ...
    public void setGraphicId(@javax.annotation.Nonnull Long graphicId) {
        this.graphicId = graphicId;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("collision_file", "graphic_file", "graphic_id",
                "icon_folder", "sof_dna", "sof_fation_name", "sof_hull_name", "sof_race_name"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("graphic_id"));
    }

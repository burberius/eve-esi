...
public class CharacterSkillsResponse implements Serializable {
    @JsonProperty("skills")
    private List<CharacterSkillsResponseSkills> skills = new ArrayList<CharacterSkillsResponseSkills>();

    @JsonProperty("total_sp")
    private Long totalSp = null;

    public CharacterSkillsResponse skills(List<CharacterSkillsResponseSkills> skills) {
        this.skills = skills;
        return this;
    }
    ...
    public void setSkills(List<CharacterSkillsResponseSkills> skills) {
        this.skills = skills;
    }

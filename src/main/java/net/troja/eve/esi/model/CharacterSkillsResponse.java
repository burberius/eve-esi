...
import net.troja.eve.esi.model.Skills;
...
public class CharacterSkillsResponse implements Serializable {
    ...
    public CharacterSkillsResponse skills(@javax.annotation.Nonnull List<Skills> skills) {
        this.skills = skills;
        return this;
    }

    public CharacterSkillsResponse addSkillsItem(Skills skillsItem) {
        if (this.skills == null) {
    ...
    public void setSkills(@javax.annotation.Nonnull List<Skills> skills) {
        this.skills = skills;
    }
    ...
    public CharacterSkillsResponse unallocatedSp(@javax.annotation.Nullable Long unallocatedSp) {
     ...
     */
    @javax.annotation.Nullable
    public Long getUnallocatedSp() {
        return unallocatedSp;
    }

    public void setUnallocatedSp(@javax.annotation.Nullable Long unallocatedSp) {
        this.unallocatedSp = unallocatedSp;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("skills", "total_sp", "unallocated_sp"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("skills", "total_sp"));
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (int i = 0; i < jsonArrayskills.size(); i++) {
            Skills.validateJsonElement(jsonArrayskills.get(i));
        };
    }

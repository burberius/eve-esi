...
public class FactionWarfareStatsVictoryPoints implements Serializable {
    ...
    public FactionWarfareStatsVictoryPoints lastWeek(@javax.annotation.Nonnull Integer lastWeek) {
    ...
    public FactionWarfareStatsVictoryPoints total(@javax.annotation.Nonnull Integer total) {
        this.total = total;
        return this;
    }
    ...
    public FactionWarfareStatsVictoryPoints yesterday(@javax.annotation.Nonnull Integer yesterday) {

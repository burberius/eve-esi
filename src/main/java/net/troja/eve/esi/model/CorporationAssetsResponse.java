...
public class CorporationAssetsResponse implements Serializable {
    ...
    public CorporationAssetsResponse quantity(@javax.annotation.Nonnull Long quantity) {
    ...
    public CorporationAssetsResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

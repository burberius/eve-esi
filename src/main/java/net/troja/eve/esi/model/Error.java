...
import net.troja.eve.esi.model.ErrorDetail;
...
public class Error implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Error error = (Error) o;
        return Objects.equals(this.details, error.details) && Objects.equals(this.error, error.error);
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("details", "error"));
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Error.openapiRequiredFields.isEmpty()) { // has required fields
                                                          // but JSON element is
                                                          // null
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Error.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Error' and its
                             // subtypes
            }

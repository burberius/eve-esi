...
/**
 * CorporationWalletJournalResponseInner
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class CorporationWalletJournalResponseInner implements Serializable {
    ...
    public CorporationWalletJournalResponseInner() {
    }

    public CorporationWalletJournalResponseInner amount(@javax.annotation.Nullable Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public CorporationWalletJournalResponseInner balance(@javax.annotation.Nullable Double balance) {
    ...
    public CorporationWalletJournalResponseInner contextId(@javax.annotation.Nullable Long contextId) {
    ...
    public CorporationWalletJournalResponseInner contextIdType(
            @javax.annotation.Nullable ContextIdTypeEnum contextIdType) {
        this.contextIdTypeEnum = contextIdType;
        return this;
    }

    public CorporationWalletJournalResponseInner contextIdTypeString(@javax.annotation.Nullable String contextIdType) {
    ...
    public CorporationWalletJournalResponseInner date(@javax.annotation.Nonnull OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public CorporationWalletJournalResponseInner description(@javax.annotation.Nonnull String description) {
    ...
    public CorporationWalletJournalResponseInner firstPartyId(@javax.annotation.Nullable Long firstPartyId) {
    ...
    public void setFirstPartyId(@javax.annotation.Nullable Long firstPartyId) {
        this.firstPartyId = firstPartyId;
    }

    public CorporationWalletJournalResponseInner id(@javax.annotation.Nonnull Long id) {
        this.id = id;
        return this;
    }
    ...
    public CorporationWalletJournalResponseInner reason(@javax.annotation.Nullable String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public CorporationWalletJournalResponseInner refType(@javax.annotation.Nonnull RefTypeEnum refType) {
        this.refTypeEnum = refType;
        return this;
    }

    public CorporationWalletJournalResponseInner refTypeString(@javax.annotation.Nonnull String refType) {
    ...
    public CorporationWalletJournalResponseInner secondPartyId(@javax.annotation.Nullable Long secondPartyId) {
    ...
    public void setSecondPartyId(@javax.annotation.Nullable Long secondPartyId) {
        this.secondPartyId = secondPartyId;
    }

    public CorporationWalletJournalResponseInner tax(@javax.annotation.Nullable Double tax) {
        this.tax = tax;
        return this;
    }
    ...
    public CorporationWalletJournalResponseInner taxReceiverId(@javax.annotation.Nullable Long taxReceiverId) {
    ...
    public void setTaxReceiverId(@javax.annotation.Nullable Long taxReceiverId) {
        this.taxReceiverId = taxReceiverId;
    }
    ...
    public boolean equals(Object o) {
        ...
        CorporationWalletJournalResponseInner corporationWalletJournalResponseInner = (CorporationWalletJournalResponseInner) o;
        return Objects.equals(this.amount, corporationWalletJournalResponseInner.amount)
                && Objects.equals(this.balance, corporationWalletJournalResponseInner.balance)
                && Objects.equals(this.contextId, corporationWalletJournalResponseInner.contextId)
                && Objects.equals(this.contextIdType, corporationWalletJournalResponseInner.contextIdType)
                && Objects.equals(this.date, corporationWalletJournalResponseInner.date)
                && Objects.equals(this.description, corporationWalletJournalResponseInner.description)
                && Objects.equals(this.firstPartyId, corporationWalletJournalResponseInner.firstPartyId)
                && Objects.equals(this.id, corporationWalletJournalResponseInner.id)
                && Objects.equals(this.reason, corporationWalletJournalResponseInner.reason)
                && Objects.equals(this.refType, corporationWalletJournalResponseInner.refType)
                && Objects.equals(this.secondPartyId, corporationWalletJournalResponseInner.secondPartyId)
                && Objects.equals(this.tax, corporationWalletJournalResponseInner.tax)
                && Objects.equals(this.taxReceiverId, corporationWalletJournalResponseInner.taxReceiverId);
    }
    ...
    public String toString() {
        ...
        sb.append("class CorporationWalletJournalResponseInner {\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("amount", "balance", "context_id", "context_id_type", "date",
                "description", "first_party_id", "id", "reason", "ref_type", "second_party_id", "tax",
                "tax_receiver_id"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("date", "description", "id", "ref_type"));
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CorporationWalletJournalResponseInner.openapiRequiredFields.isEmpty()) { // has
                                                                                          // required
                                                                                          // fields
                                                                                          // but
                                                                                          // JSON
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CorporationWalletJournalResponseInner is not found in the empty JSON string",
                                CorporationWalletJournalResponseInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CorporationWalletJournalResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `CorporationWalletJournalResponseInner` properties. JSON: %s",
        ...
        // JSON string
        for (String requiredField : CorporationWalletJournalResponseInner.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CorporationWalletJournalResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                             // 'CorporationWalletJournalResponseInner' and its
                             // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CorporationWalletJournalResponseInner> thisAdapter = gson.getDelegateAdapter(this,
                    TypeToken.get(CorporationWalletJournalResponseInner.class));

            return (TypeAdapter<T>) new TypeAdapter<CorporationWalletJournalResponseInner>() {
                @Override
                public void write(JsonWriter out, CorporationWalletJournalResponseInner value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public CorporationWalletJournalResponseInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of CorporationWalletJournalResponseInner given an JSON
     * string
     *
     * @param jsonString
     *            JSON string
     * @return An instance of CorporationWalletJournalResponseInner
     * @throws IOException
     *             if the JSON string is invalid with respect to
     *             CorporationWalletJournalResponseInner
     */
    public static CorporationWalletJournalResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CorporationWalletJournalResponseInner.class);
    }

    /**
     * Convert an instance of CorporationWalletJournalResponseInner to an JSON
     * string
     *
     * @return JSON string
     */

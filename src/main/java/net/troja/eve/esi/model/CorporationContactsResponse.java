...
public class CorporationContactsResponse implements Serializable {
    ...
    public CorporationContactsResponse contactId(@javax.annotation.Nonnull Long contactId) {
    ...
    public CorporationContactsResponse standing(@javax.annotation.Nonnull Double standing) {

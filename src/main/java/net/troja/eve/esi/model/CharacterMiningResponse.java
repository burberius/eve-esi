...
public class CharacterMiningResponse implements Serializable {
    ...
    public CharacterMiningResponse solarSystemId(@javax.annotation.Nonnull Long solarSystemId) {
    ...
    public CharacterMiningResponse typeId(@javax.annotation.Nonnull Long typeId) {
        this.typeId = typeId;
        return this;
    }

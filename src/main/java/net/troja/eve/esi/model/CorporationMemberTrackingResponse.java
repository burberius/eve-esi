...
public class CorporationMemberTrackingResponse implements Serializable {
    ...
    public CorporationMemberTrackingResponse baseId(@javax.annotation.Nullable Long baseId) {
        this.baseId = baseId;
        return this;
    }
    ...
    public CorporationMemberTrackingResponse characterId(@javax.annotation.Nonnull Long characterId) {
    ...
    public CorporationMemberTrackingResponse shipTypeId(@javax.annotation.Nullable Long shipTypeId) {

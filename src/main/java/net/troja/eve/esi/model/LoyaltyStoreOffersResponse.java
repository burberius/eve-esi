...
import net.troja.eve.esi.model.LoyaltyStoreRequiredItem;
...
public class LoyaltyStoreOffersResponse implements Serializable {
    ...
    @javax.annotation.Nonnull
    private List<LoyaltyStoreRequiredItem> requiredItems;
    ...
    public LoyaltyStoreOffersResponse requiredItems(
            @javax.annotation.Nonnull List<LoyaltyStoreRequiredItem> requiredItems) {
        this.requiredItems = requiredItems;
        return this;
    }

    public LoyaltyStoreOffersResponse addRequiredItemsItem(LoyaltyStoreRequiredItem requiredItemsItem) {
     ...
     */
    @javax.annotation.Nonnull
    public List<LoyaltyStoreRequiredItem> getRequiredItems() {
        return requiredItems;
    }

    public void setRequiredItems(@javax.annotation.Nonnull List<LoyaltyStoreRequiredItem> requiredItems) {
        this.requiredItems = requiredItems;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (int i = 0; i < jsonArrayrequiredItems.size(); i++) {
            LoyaltyStoreRequiredItem.validateJsonElement(jsonArrayrequiredItems.get(i));
        };
    }

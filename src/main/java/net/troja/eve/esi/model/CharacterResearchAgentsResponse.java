...
public class CharacterResearchAgentsResponse implements Serializable {
    ...
    public CharacterResearchAgentsResponse agentId(@javax.annotation.Nonnull Long agentId) {
    ...
    public CharacterResearchAgentsResponse pointsPerDay(@javax.annotation.Nonnull Double pointsPerDay) {
    ...
    public CharacterResearchAgentsResponse remainderPoints(@javax.annotation.Nonnull Double remainderPoints) {
    ...
    public CharacterResearchAgentsResponse skillTypeId(@javax.annotation.Nonnull Long skillTypeId) {

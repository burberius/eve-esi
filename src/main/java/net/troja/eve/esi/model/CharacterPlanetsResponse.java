...
public class CharacterPlanetsResponse implements Serializable {
    ...
    private transient PlanetTypeEnum planetTypeEnum;
    ...
    public CharacterPlanetsResponse numPins(@javax.annotation.Nonnull Long numPins) {
    ...
    public CharacterPlanetsResponse ownerId(@javax.annotation.Nonnull Long ownerId) {
    ...
    public CharacterPlanetsResponse planetId(@javax.annotation.Nonnull Long planetId) {
    ...
    public CharacterPlanetsResponse solarSystemId(@javax.annotation.Nonnull Long solarSystemId) {
    ...
    public CharacterPlanetsResponse upgradeLevel(@javax.annotation.Nonnull Long upgradeLevel) {

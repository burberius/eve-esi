...
public class CharacterContractsResponse implements Serializable {
    ...
    public CharacterContractsResponse availability(String availability) {
    ...
    public CharacterContractsResponse status(String status) {
    ...
    public CharacterContractsResponse type(String type) {

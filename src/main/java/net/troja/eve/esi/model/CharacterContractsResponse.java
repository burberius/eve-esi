...
public class CharacterContractsResponse implements Serializable {
    ...
    /**
     * Who will accept the contract. If assignee_id is same as acceptorID then
     * character ID else corporation ID (The contract accepted by the
     * corporation)
     * 
     * @return acceptorId
     **/
    @ApiModelProperty(example = "null", required = true, value = "Who will accept the contract. If assignee_id is same as acceptorID then character ID else corporation ID (The contract accepted by the corporation)")

...
public class RetryingOAuth extends OAuth implements Interceptor {
     ...
     * @param client
     *            An OkHttp client
     * @param tokenRequestBuilder
     *            A token request builder
     */
    ...
    /**
     * @param tokenUrl
     *            The token URL to be used for this OAuth2 flow. Applicable to
     *            the following OAuth2 flows: "password", "clientCredentials"
     *            and "authorizationCode". The value must be an absolute URL.
     * @param clientId
     *            The OAuth2 client ID for the "clientCredentials" flow.
     * @param flow
     *            OAuth flow.
     * @param clientSecret
     *            The OAuth2 client secret for the "clientCredentials" flow.
     * @param parameters
     *            A map of string.
     */
    public RetryingOAuth(String tokenUrl, String clientId, OAuthFlow flow, String clientSecret,
    ...
    private Response retryingIntercept(Chain chain, boolean updateTokenAndRetryOnAuthorizationFailure)
        ...
        // If the request already has an authorization (e.g. Basic auth),
        ...
        if (getAccessToken() != null) {
            ...
            // 401/403 response codes most likely indicate an expired access
            // token, unless it happens two times in a row
            if (response != null
     ...
     *             If fail to update the access token
     */

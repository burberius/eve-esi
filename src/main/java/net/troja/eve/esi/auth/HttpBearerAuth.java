...
public class HttpBearerAuth implements Authentication {
    ...
    /**
     * Sets the supplier of tokens, which together with the scheme, will be sent
     * as the value of the Authorization header.
     *
     * @param tokenSupplier
     *            The supplier of bearer tokens to send in the Authorization
     *            header
     */

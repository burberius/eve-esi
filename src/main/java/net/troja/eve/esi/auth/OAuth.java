...
public class OAuth implements Authentication {
    ...
    /**
     * Get codeVerifier generated by the last call to `getAuthorizationUri`
     * Useful if `finishFlow` needs to be called from another instance of
     * `OAuth`
     * 
     * @return
     */
     ...
     *            getAuthorizationUri
     * @param codeVerifier
     *            Required if `finishFlow` is not called by the same instance of
     *            `OAuth` that called `getAuthorizationUri`

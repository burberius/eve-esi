...
public class SovereigntyApi {
     ...
     *             if fails to make API call
     */
    public List<SovereigntyMapResponse> getSovereigntyMap(String datasource, String userAgent, String xUserAgent)
            throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<List<SovereigntyMapResponse>> localVarReturnType = new GenericType<List<SovereigntyMapResponse>>() {
        };
        return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams,
                localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }

...
public class OpportunitiesApi {
    ...
    public okhttp3.Call getCharactersCharacterIdOpportunitiesCall(Integer characterId, String datasource,
        ...
        String localVarPath = "/v1/characters/{character_id}/opportunities/".replace("{" + "character_id" + "}",
     ...
     * a character --- This route is cached for up to 3600 seconds --- Warning:
     * This route is deprecated SSO Scope: esi-characters.read_opportunities.v1
     * 
     * @param characterId
     *            An EVE character ID (required)
     * @param datasource
     ...
     * seconds --- Warning: This route is deprecated SSO Scope:
     ...
     * route expires daily at 11:05 --- Warning: This route is deprecated
     * 
     * @param datasource
     *            The server name you would like data from (optional, default to
     *            tranquility)
     ...
     * groups --- This route expires daily at 11:05 --- Warning: This route is
     * deprecated
     * 
     * @param datasource
     *            The server name you would like data from (optional, default to
    ...
    public okhttp3.Call getOpportunitiesGroupsGroupIdCall(Integer groupId, String acceptLanguage, String datasource,
        ...
        // create path and map variables
        String localVarPath = "/v1/opportunities/groups/{group_id}/".replace("{" + "group_id" + "}",
     ...
     * This route expires daily at 11:05 --- Warning: This route is deprecated
     * 
     * @param groupId
     *            ID of an opportunities group (required)
     * @param acceptLanguage
     ...
     * opportunities group --- This route expires daily at 11:05 --- Warning:
     ...
     * tasks --- This route expires daily at 11:05 --- Warning: This route is
     * deprecated
     * 
     * @param datasource
     *            The server name you would like data from (optional, default to
    ...
    public okhttp3.Call getOpportunitiesTasksTaskIdCall(Integer taskId, String datasource, String ifNoneMatch,
        ...
        // create path and map variables
        String localVarPath = "/v1/opportunities/tasks/{task_id}/".replace("{" + "task_id" + "}",
     ...
     * opportunities task --- This route expires daily at 11:05 --- Warning:
     * This route is deprecated
     * 
     * @param taskId
     *            ID of an opportunities task (required)

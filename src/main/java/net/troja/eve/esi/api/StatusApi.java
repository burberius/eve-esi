...
public class StatusApi {
     ...
     */
    public StatusResponse getStatus(String datasource, String userAgent, String xUserAgent) throws ApiException {
        ...
        GenericType<StatusResponse> localVarReturnType = new GenericType<StatusResponse>() {
        };

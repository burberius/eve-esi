...
public class LocationApi {
     ...
     * cached for up to 5 seconds --- [Diff of the upcoming
     * changes](https://esi.
     * evetech.net/diff/latest/dev/#GET-/characters/{character_id}/ship/) SSO
     ...
     * --- This route is cached for up to 5 seconds --- [Diff of the upcoming
     * changes
     * ](https://esi.evetech.net/diff/latest/dev/#GET-/characters/{character_id
     * }/ship/) SSO Scope: esi-location.read_ship_type.v1
     * 
     * @param characterId
     *            An EVE character ID (required)
     * @param datasource

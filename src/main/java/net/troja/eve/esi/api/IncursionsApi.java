...
public class IncursionsApi {
     ...
     *                        </table>
     */
    public okhttp3.Call getIncursionsCall(@javax.annotation.Nonnull LocalDate xCompatibilityDate,
    ...
    private okhttp3.Call getIncursionsValidateBeforeCall(@javax.annotation.Nonnull LocalDate xCompatibilityDate,
            @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String ifNoneMatch,
            @javax.annotation.Nullable String xTenant, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xCompatibilityDate' is set
        if (xCompatibilityDate == null) {
            throw new ApiException(
                    "Missing the required parameter 'xCompatibilityDate' when calling getIncursions(Async)");
        }

        return getIncursionsCall(xCompatibilityDate, acceptLanguage, ifNoneMatch, xTenant, _callback);

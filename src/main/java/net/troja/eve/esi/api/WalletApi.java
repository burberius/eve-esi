...
public class WalletApi {
     ...
     * @param xUserAgent
     *            Client identifier, takes precedence over User-Agent (optional)
     * @return List&lt;CharacterWalletsJournalResponse&gt;
     * @throws ApiException
     *             if fails to make API call
     */
    public List<CharacterWalletsJournalResponse> getCharactersCharacterIdWalletsJournal(Integer characterId,
            String datasource, Long fromId, String token, String userAgent, String xUserAgent) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (characterId == null) {
            throw new ApiException(400,
                    "Missing the required parameter 'characterId' when calling getCharactersCharacterIdWalletsJournal");
        }

        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/wallets/journal/".replaceAll("\\{format\\}", "json")
                .replaceAll("\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
        ...
        GenericType<List<CharacterWalletsJournalResponse>> localVarReturnType = new GenericType<List<CharacterWalletsJournalResponse>>() {
        };
        return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams,
                localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }

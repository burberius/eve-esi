...
public class CharacterApi {
    ...
    public CharacterFatigueResponse getCharactersCharacterIdFatigue(Integer characterId, String datasource,
        ...
        GenericType<CharacterFatigueResponse> localVarReturnType = new GenericType<CharacterFatigueResponse>() {
        };
        return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams,
                localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    ...
    public List<CharacterNotificationsResponse> getCharactersCharacterIdNotifications(Integer characterId,
        ...
        GenericType<List<CharacterNotificationsResponse>> localVarReturnType = new GenericType<List<CharacterNotificationsResponse>>() {
        };
        return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams,
                localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    ...
    public List<NewContactNotificationsResponse> getCharactersCharacterIdNotificationsContacts(Integer characterId,
        ...
        GenericType<List<NewContactNotificationsResponse>> localVarReturnType = new GenericType<List<NewContactNotificationsResponse>>() {
        };
        return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams,
                localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }

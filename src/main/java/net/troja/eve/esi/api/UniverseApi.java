...
public class UniverseApi {
     ...
     *                        </table>
     */
    public UniverseStructureResponse getStructure(@javax.annotation.Nonnull Long structureId,
            @javax.annotation.Nonnull LocalDate xCompatibilityDate, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant)
            throws ApiException {
        ApiResponse<UniverseStructureResponse> localVarResp = getStructureWithHttpInfo(structureId, xCompatibilityDate,
                acceptLanguage, ifNoneMatch, xTenant);
        return localVarResp.getData();
    }
     ...
     *                        </table>
     */
    public ApiResponse<UniverseStructureResponse> getStructureWithHttpInfo(@javax.annotation.Nonnull Long structureId,
            @javax.annotation.Nonnull LocalDate xCompatibilityDate, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant)
            throws ApiException {

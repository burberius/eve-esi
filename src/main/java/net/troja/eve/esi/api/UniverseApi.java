...
public class UniverseApi {
     ...
     *             If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUniverseIdsCall(List<String> names, String acceptLanguage, String datasource,
            String language, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     *             If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUniverseNamesCall(List<Integer> ids, String datasource,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {

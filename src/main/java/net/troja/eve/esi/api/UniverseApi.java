...
public class UniverseApi {
     ...
     *                        </table>
     */
    public okhttp3.Call getStructureCall(@javax.annotation.Nonnull Long structureId,
            @javax.annotation.Nonnull LocalDate xCompatibilityDate, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant,
            final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStructureValidateBeforeCall(@javax.annotation.Nonnull Long structureId,
            @javax.annotation.Nonnull LocalDate xCompatibilityDate, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant,
            final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'structureId' is set
        if (structureId == null) {
            throw new ApiException("Missing the required parameter 'structureId' when calling getStructure(Async)");
        }

        // verify the required parameter 'xCompatibilityDate' is set
        if (xCompatibilityDate == null) {
            throw new ApiException(
                    "Missing the required parameter 'xCompatibilityDate' when calling getStructure(Async)");
        }

        return getStructureCall(structureId, xCompatibilityDate, acceptLanguage, ifNoneMatch, xTenant, _callback);
     ...
     *                        </table>
     */
    public StructureResponse getStructure(@javax.annotation.Nonnull Long structureId,
            @javax.annotation.Nonnull LocalDate xCompatibilityDate, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant)
            throws ApiException {
        ApiResponse<StructureResponse> localVarResp = getStructureWithHttpInfo(structureId, xCompatibilityDate,
                acceptLanguage, ifNoneMatch, xTenant);
        return localVarResp.getData();
    }
     ...
     *                        </table>
     */
    public ApiResponse<StructureResponse> getStructureWithHttpInfo(@javax.annotation.Nonnull Long structureId,
            @javax.annotation.Nonnull LocalDate xCompatibilityDate, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant)
            throws ApiException {
        okhttp3.Call localVarCall = getStructureValidateBeforeCall(structureId, xCompatibilityDate, acceptLanguage,
                ifNoneMatch, xTenant, null);
     ...
     *                        </table>
     */
    public okhttp3.Call getStructureAsync(@javax.annotation.Nonnull Long structureId,
            @javax.annotation.Nonnull LocalDate xCompatibilityDate, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant,
            final ApiCallback<StructureResponse> _callback) throws ApiException {
     ...
     *                        </table>
     */
    public UniverseIds postUniverseIds(@javax.annotation.Nonnull LocalDate xCompatibilityDate,
            @javax.annotation.Nonnull Set<String> requestBody, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant)
            throws ApiException {
        ApiResponse<UniverseIds> localVarResp = postUniverseIdsWithHttpInfo(xCompatibilityDate, requestBody,
                acceptLanguage, ifNoneMatch, xTenant);
        return localVarResp.getData();
    }
     ...
     *            The tenant ID for the request. (optional, default to
     *            tranquility)
     * @return ApiResponse&lt;UniverseIds&gt;
     * @throws ApiException
     *             If fail to call the API, e.g. server error or cannot
     *             deserialize the response body
     * @http.response.details <table border="1">
     ...
     *                        </table>
     */
    public ApiResponse<UniverseIds> postUniverseIdsWithHttpInfo(@javax.annotation.Nonnull LocalDate xCompatibilityDate,
            @javax.annotation.Nonnull Set<String> requestBody, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant)
            throws ApiException {
        okhttp3.Call localVarCall = postUniverseIdsValidateBeforeCall(xCompatibilityDate, requestBody, acceptLanguage,
                ifNoneMatch, xTenant, null);
        Type localVarReturnType = new TypeToken<UniverseIds>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call postUniverseIdsAsync(@javax.annotation.Nonnull LocalDate xCompatibilityDate,
            @javax.annotation.Nonnull Set<String> requestBody, @javax.annotation.Nullable String acceptLanguage,
            @javax.annotation.Nullable String ifNoneMatch, @javax.annotation.Nullable String xTenant,
            final ApiCallback<UniverseIds> _callback) throws ApiException {

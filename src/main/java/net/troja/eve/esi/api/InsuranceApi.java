...
public class InsuranceApi {
     ...
     *                        </table>
     */
    public okhttp3.Call getInsurancePricesCall(@javax.annotation.Nonnull LocalDate xCompatibilityDate,
    ...
    private okhttp3.Call getInsurancePricesValidateBeforeCall(@javax.annotation.Nonnull LocalDate xCompatibilityDate,
            @javax.annotation.Nullable String acceptLanguage, @javax.annotation.Nullable String ifNoneMatch,
            @javax.annotation.Nullable String xTenant, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xCompatibilityDate' is set
        if (xCompatibilityDate == null) {
            throw new ApiException(
                    "Missing the required parameter 'xCompatibilityDate' when calling getInsurancePrices(Async)");
        }

        return getInsurancePricesCall(xCompatibilityDate, acceptLanguage, ifNoneMatch, xTenant, _callback);

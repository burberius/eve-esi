...
public class ApiClient {
    ...
    protected String basePath = "https://esi.evetech.net";
     ...
     *
     * @param client
     *            a {@link okhttp3.OkHttpClient} object
     */
     ...
     *            client ID
     * @param parameters
     *            a {@link java.util.Map} of parameters
     */
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://login.eveonline.com/v2/oauth/token";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/2025-09-26/java");
     ...
     *
     * @param dateFormat
     *            a {@link java.time.format.DateTimeFormatter} object
     * @return a {@link net.troja.eve.esi.ApiClient} object
     */
     ...
     *
     * @param value
     *            The free-form query parameters.
     * @return A list of {@code Pair} objects.
     */
        ...
        try {
            if (isJsonMime(contentType)) {
                ...
                throw new ApiException("Content type \"" + contentType + "\" is not supported for type: " + returnType,
                        response.code(), response.headers().toMultimap(), response.body().string());
            }
        } catch (IOException e) {
            throw new ApiException(e);
        }
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams,
        ...
        final Request.Builder reqBuilder = new Request.Builder().url(buildUrl(baseUrl, path, updatedQueryParams,
     ...
     *            MultipartBody.Builder
     * @param key
     *            The key of the Header element
     * @param file
     *            The file to add to the Header
     */
     ...
     *            The key of the Header element
     * @param obj
     *            The complex object to add to the Header
     */
     ...
     * @throws net.troja.eve.esi.ApiException
     *             If fail to serialize the request body object into a string
     */

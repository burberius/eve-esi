...
public class ApiClient {
    ...
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(
            Arrays.asList(new ServerConfiguration("https://esi.evetech.net", "No description provided",
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = uri.getScheme() + ":" + (uri.getAuthority() != null ? "//" + uri.getAuthority() : "");
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.30/java");
     ...
     * @return a {@link net.troja.eve.esi.ApiClient} object
     */
     ...
     * @throws net.troja.eve.esi.ApiException If fail to deserialize response body, i.e. cannot read
     ...
     * @throws net.troja.eve.esi.ApiException If fail to serialize the given object
     */
     ...
     * @throws net.troja.eve.esi.ApiException If fail to read file content from response and write to disk
     */
     ...
     * @throws net.troja.eve.esi.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws net.troja.eve.esi.ApiException If the response has an unsuccessful status code or fail to
     ...
     * @throws net.troja.eve.esi.ApiException If fail to serialize the request body object
     */
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams,
        ...
        updateParamsForAuth(authNames, allQueryParams, headerParams, cookieParams, requestBodyToString(reqBody),
     ...
     * @param uri          URI
     * @throws net.troja.eve.esi.ApiException If fails to update the parameters
     */
    ...
    /**
     * Add a Content-Disposition Header for the given key and complex object to
     ...
     * @throws net.troja.eve.esi.ApiException If fail to serialize the request body object into a string
     */
